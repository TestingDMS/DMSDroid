...
if __name__ == '__main__':
    apk_dir = r'G:\QRS\apks'
    output_dir = r'G:\QRS\result\ses4'
    ...
    for filename in apk_list:
        if len(filename.split(".")) == 2 and filename.split(".")[1] == "apk":
            ...
            sestesting_pipe = subprocess.Popen(
                args=f'droidbot -d emulator-5554 -a {apk_apth} -o {droidbot_out} -timeout 7200 -interval 0 -random -is_emulator',
                # stdin=subprocess.PIPE,
                # stdout=subprocess.PIPE,
                # stderr=subprocess.PIPE,
                shell=True,
                cwd=r'G:\QRS\result\ses4'
            )
